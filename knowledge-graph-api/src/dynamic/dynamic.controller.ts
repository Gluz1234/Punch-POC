...
export class DynamicController {
  ...
  // Body: { label, properties? } or { label, fields? }
  ...
  @ApiBody({
    schema: {
      oneOf: [
        { example: { label: 'Course', properties: { entity_id: 'C-3001', name: 'Distributed Systems' } } },
        { example: { label: 'Course', fields: { entity_id: 'C-3001', name: 'Distributed Systems' } } },
      ],
    },
  })
  smartCreate(@Body() dto: { label?: string; properties?: Record<string, any>; fields?: Record<string, any> }) {
